 ...
 *  Virtual Tide Bouy
 *
 *  Copyright 2014 David Lounsbury
 *
 ...
 */
 //
 //TODO: Change tiles for tide data
 //TODO: Change Capabilities for tide data
 //Will need input tile for API key
 //
metadata {
	definition (name: "Virtual Tide Bouy", namespace: "technodad", author: "David Lounsbury") {
...
//NOTES: This uses the WeatherUnderground Data API http://www.wunderground.com/weather/api/d/docs?d=data/index
//
// handle commands
def poll() {
